...
@section('title','Retificação de fatura de outros serviços')
<div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="widget-box transparent">
                                    <div class="widget-header widget-header-large">
                                        ...
                                        <h5>NOTA DE CRÉDITO DE RETIFICAÇÃO - OUTROS SERVIÇOS</h5>
                                    </div>
                                                                ...
                                                                <form class="form-inline">
                                                                    <div class="row">
                                                                        <div class="form-group col-md-2"
                                                                            ...
                                                                            <div>
                                                                                <input type="text"
                                                                                       wire:model="fatura.numeroAeronave"
                                                                                       style="width: 100%;<?= $errors->has('fatura.numeroAeronave') ? 'border-color: #ff9292;' : '' ?>"
                                                                                       class="input-small"
                                                                                       placeholder="BOING 737-800"/>

                                                                            </div>
                                                                            @if ($errors->has('fatura.numeroAeronave'))
                                                                                <span class="help-block"
                                                                                      style="color: red; font-weight: bold;position:absolute;">
                                                                                    <strong>{{ $errors->first('fatura.numeroAeronave') }}</strong>
                                                                                </span>
                                                                            @endif
                                                                        </div>
                                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <tr>
                                                                <td class="center">
                                                                    <select style="width: 100%;" ;
                                                                            <?= $errors->has('item.produto') ? 'border-color: #ff9292;' : '' ?>
                                                                ...
                                                                <td class="center">
                                                                    <input name="form-field-checkbox"
                                                                           wire:model="item.quantidade" id="quantidade"
                                                                           type="number"
                                                                           style="width: 100%;height: 25px <?= $errors->has('item.quantidade') ? 'border-color: #ff9292;' : '' ?>"/>
