                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main padding-24">
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul class="list-unstyled  spaced">
                                                            <div style="margin-top: 10px; margin-bottom: 15px;">
                                                                <li>
                                                                    <select wire:model="fatura.clienteId" data="clienteId" class="col-md-12 select2" id="clienteId" style="height:35px;">
                                                                ...
                                                                <form class="form-inline">
                                                                    <div class="row">
                                                                        <div class="form-group col-md-2">
                                                                            ...
                                                                            <div>
                                                                                <select style="width: 100%;height: 34px" wire:model="fatura.tipoDocumento" name="ship" rowid="6" size="1" class="editable inline-edit-cell ui-widget-content ui-corner-all">
                                                                        ...
                                                                        <div class="form-group col-md-2">
                                                                            ...
                                                                            <div>
                                                                                <select style="width: 100%;height: 34px" wire:model="fatura.formaPagamentoId" name="ship" rowid="6" size="1" class="editable inline-edit-cell ui-widget-content ui-corner-all">
                                                                        ...
                                                                        <div class="form-group col-md-1">
                                                                            <label>Moeda</label>
                                                                            <div>
                                                                                <select style="width: 100%;height: 34px" wire:model="fatura.moedaPagamento" name="ship" rowid="6" size="1" class="editable inline-edit-cell ui-widget-content ui-corner-all">
                                                                        ...
                                                                        <div class="form-group col-1" style="margin-left: 15px">
                                                                            ...
                                                                            <div>
                                                                                <input name="form-field-checkbox" wire:model="fatura.isencaoIVA" id="isencaoIva" type="checkbox" class="ace input-lg" />
                                                                                <span class="lbl bigger-140"></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group col-1" style="margin-left: 15px">
                                                                            <label for="retencao">Incluir
                                                                                Retenção</label>
                                                                            <div>
                                                                                <input name="form-field-checkbox" wire:model="fatura.retencao" id="retencao" type="checkbox" class="ace input-lg" />
                                                                                <span class="lbl bigger-140"></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <table class="table table-striped table-bordered">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center">{{ number_format($faturaItem['desconto'],1,',','.') }}</td>
                                                                    <td style="text-align: right">{{ number_format($faturaItem['total'],2,',','.') }}</td>
                                                                    <td style="text-align: center">
                                                                        <div class="hidden-sm hidden-xs btn-group">
                                                                            <button class="btn btn-xs btn-danger" wire:click.prevent="removeCart({{json_encode($faturaItem) }})">
                                                        ...
                                                        <table class="table table-striped table-bordered">
                                                            <thead>
                                                                <tr>
                                                                    <th>Tarifas</th>
                                                                    <th>Desc(%)</th>
                                                                    <th>Qtd lugares oferecido / Qtd passes / Qtd litros / Kg
                                                                        / Qtd passageiros
                                                                    </th>
                                                                    <th></th>
                                                                </tr>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="center">
                                                                        <select style="width: 100%;" ; <?= $errors->has('item.produto') ? 'border-color: #ff9292;' : '' ?> wire:model="item.produto" name="ship" rowid="6" size="1" class="editable inline-edit-cell ui-widget-content ui-corner-all">
                                                                            <option value="">Nenhum</option>
                                                                            @foreach($servicos as $servico)
                                                                            <option value="{{json_encode($servico->produto)}}">{{ Str::title($servico->produto->designacao) }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td class="center">
                                                                        <input name="form-field-checkbox" wire:model="item.quantidade" id="quantidade" type="number" style="width: 100%;height: 25px; <?= $errors->has('item.quantidade') ? 'border-color: #ff9292;' : '' ?>" />
                                                                    ...
                                                                    <td>
                                                                        <div class="hidden-sm hidden-xs btn-group">
                                                                            <button class="btn btn-xs btn-success" wire:click.prevent="addCart">
                                            ...
                                            <div class="well" style="display: flex;justify-content: space-between;">
                                                ...
                                                <div>
                                                    <a href="#" class="btn btn-primary btn-app radius-4" wire:click.prevent="emitirDocumento" wire:keydown.enter="preventEnter">
