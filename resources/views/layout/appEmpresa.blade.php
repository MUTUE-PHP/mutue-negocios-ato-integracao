        ...
        <ul class="nav nav-list">
            ...
            <li class="hover">
                ...
                <ul class="submenu">
                    ...
                    <li class="hover">
                        <a href="{{ route('notacreditos.index')}}">
                            <i class="menu-icon fa fa-caret-right"></i>
                            NOTAS DE CRÉDITO</a>
                        <b class="arrow"></b>
                    </li>
                    <!-- <li class="hover">
                        <a href="{{ route('retificacaoDocumentoFatura.index')}}">
                            <i class="menu-icon fa fa-caret-right"></i>
                            RETIFICAÇÃO FATURAS</a>
                        <b class="arrow"></b>
                    </li> -->
                    {{--                    <li class="hover">--}}
                ...
                <li class="hover">
                    ...
                    <ul class="submenu">
                        @foreach($modulos as $modulo)
                            <li class="hover">
                                <a href="{{ $modulo->url }}{{"?email=". base64_encode(base64_encode(base64_encode($modulo->email)))}}" target="_blank">
                                    <i class="menu-icon fa fa-pencil" style="color: white;"></i>
                                    {{ Str::upper($modulo->designacao) }}
                                </a>
                                <b class="arrow"></b>
                            </li>
                        @endforeach
...
<script type="text/javascript">
    ...
    function urlLogistica(email) {
        // Variáveis com valores

        var appUrl = "{{ env('URL_LOGISTICA') }}";
        var email = "mutue@gmail.com";
        var emailEncoded = btoa(btoa(btoa(email)));
        window.open(appUrl + "?email=" + emailEncoded, "_blank");
    }

    function urlContasCerta() {
        // Variáveis com valores
        var appUrl = "{{ env('URL_CONTASCERTAS') }}";
        var email = "mutue@gmail.com";
        var emailEncoded = btoa(btoa(btoa(email)));
        window.open(appUrl + "?email=" + emailEncoded, "_blank");
    }

    function urlGestaoPessoa() {
        // Variáveis com valores
        var appUrl = "{{ env('URL_GESTAOPESSOA') }}";
        var email = "mutue@gmail.com";
        var emailEncoded = btoa(btoa(btoa(email)));
        window.open(appUrl + "?email=" + emailEncoded, "_blank");
    }
