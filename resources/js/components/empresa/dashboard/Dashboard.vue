        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="infobox infobox-red" style="cursor:pointer;position: relative" data-toggle="dropdown" >
                ...
                <div class="infobox-content" style="max-width: 160px !important">
                  <span class="bigger-110" style="color: black">Total de Faturas Recibo</span>
                </div>
              </a>
                    ...
                    <ul class="dropdown-menu dropdown-yellow dropdown-caret" >
                        <li v-for="tipoServico in tiposservicos">
                            <a v-on:click.prevent="showInvoice(tipoServico.url)">
                                {{ tipoServico.designacao.toUpperCase()}}
                            </a>
                        </li>
                    </ul>
                </div>
              ...
              <div class="infobox infobox-red" style="cursor:pointer;position: relative" data-toggle="dropdown" >
                  <a class="infobox-data dropdown-toggle" data-toggle="dropdown" style="pointer-events: none;">
                <span class="infobox-data-number">{{
                  counttotalfactura | currency
                }}</span>
                <div class="infobox-content">
                  <span class="bigger-110" style="color: black">Total de Facturas</span>
                </div>
              </a>
                  <i class="ace-icon fa fa-caret-down"></i>
                  <div style="position:absolute;">
            ...
            <div class="infobox infobox-red">
              <div class="infobox-data">
                <span class="infobox-data-number">{{
                  ...
                  <div class="infobox-content" style="max-width: 170px !important">
                  <span class="bigger-110" style="color: black">Total de Faturas Proforma</span>
                </div>
              </div>
                <i class="ace-icon fa fa-caret-down"></i>
            </div>
