                                    ...
                                    @foreach ($facturas as $key=>$factura)
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <a>
                                                        <span
                                                            class="label label-sm <?= $factura['retificado'] == 'Y'?'label-danger':'label-success'?>">{{ $factura['retificado'] == 'Y'?"Sim":"Não" }}
                                                    </span>
                                                </a>
