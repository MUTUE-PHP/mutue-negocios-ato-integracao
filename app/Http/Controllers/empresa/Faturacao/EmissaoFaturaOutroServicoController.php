...
class EmissaoFaturaOutroServicoController extends Component
{
    ...
    public function updatedItemQuantidade($qtd)
    {
        $qtd = empty($qtd) ? null : $qtd;
        $this->item['quantidade'] = $qtd;
    }
    ...
    public function addCart()
    {
        ...
        $rules = [
            ...
            'item.quantidade' => [
                'required',
                function ($attr, $qtd, $fail) use ($produtoData) {
        ...
        $this->item['quantidade'] = (float)$this->item['quantidade'];
