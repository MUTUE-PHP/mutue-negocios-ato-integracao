@section('title', 'Facturas outros serviços')
<div>
    <div class="row">
        <div class="page-header" style="left: 0.5%; position: relative">
            <h1>
                FACTURAS - OUTROS SERVIÇOS
                <small>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                ...
                                                @if($factura['anulado'] != 'Y')
                                                    <a href="{{ route('anulacaoFaturaOutroServicoCreate', $factura['id']) }}"
                                                       class="pink"
                                                       title="anulação de documento">
                                                        <i class="ace-icon fa fa-times-circle-o bigger-160 bolder danger text-danger"></i>
                                                    </a>
                                                    <a href="{{ route('retificacaoFaturaOutroServicoCreate', $factura['id']) }}"
                                                       class="pink"
